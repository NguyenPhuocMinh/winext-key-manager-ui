...
import { updateGroupByIdAction, resetGroupRecord } from '@customActions/index';
...
const DetailTab = (props) => {
  ...
  const handleUpdate = (groupID, values) => {
    dispatch(
      updateGroupByIdAction(groupID, {
        name: values.name,
          ...
          <CardContent>
            ...
            >
              <Box sx={{ marginRight: '2em', marginBottom: '2em' }}>
                <TextInputBootStrap
                  label="resources.manages.groups.fields.id"
                  disabled
                  id="id"
                  source="id"
              ...
              <Box sx={{ marginRight: '2em', marginBottom: '2em' }}>
                <TextInputBootStrap
                  label="resources.manages.groups.fields.createdAt"
                  disabled
                  id="createdAt"
                  source="createdAt"
                  className={classes.input}
